...
const processSteps = [
  {
    ...
    description:
      "We start with a detailed discussion about your project goals, target audience, and requirements. I analyze your needs and create a comprehensive project plan.",
    duration: "1-2 days",
    deliverables: [
  ...
  },
  {
    ...
    description:
      "Based on your requirements, I create wireframes and interactive prototypes. We iterate on the design until it perfectly matches your vision.",
    duration: "3-5 days",
  ...
  },
  {
    ...
    title: "Development",
    description:
      "I build your application using modern technologies and best practices. Regular updates keep you informed of progress throughout development.",
    duration: "1-4 weeks",
    deliverables: [
  ...
  },
  {
    ...
    description:
      "Comprehensive testing ensures your application works flawlessly across all devices and browsers. I test for performance, accessibility, and user experience.",
    duration: "2-3 days",
    deliverables: [
  ...
  },
  {
    ...
    description:
      "I handle the deployment process and provide ongoing support. You'll receive documentation and training to manage your new application effectively.",
    duration: "1-2 days",
      ...
      <div className="flex flex-col items-center justify-center gap-12 ">
        <div className="text-center">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl">
            My proven process ensures your project is delivered on time, within
        ...
        <div className="w-full">
          ...
          >
            ...
            <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
              Let's discuss your project and see how my process can help bring
              your vision to life. Every project is unique, and I adapt my
